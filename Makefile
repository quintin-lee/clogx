...
CORE_SRCS = config.c formatter.c dispatcher.c queue.c async.c log.c rotate.c rate_limit.c signal_handler.c plugin_loader.c prometheus_exporter.c socket_async.c
...
TESTS = test_async_lifecycle test_async_reload test_dispatcher_lifecycle \
        ...
        test_plugin_abi test_otel test_prometheus test_multi_instance test_coverage_gaps test_async_edge test_socket_async test_tls test_fast_ascii
